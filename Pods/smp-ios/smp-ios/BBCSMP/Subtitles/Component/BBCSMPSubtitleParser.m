...
- (NSDictionary*)styleDictionaryFromDictionary:(NSDictionary*)dictionary
{
    ...
    if ([dictionary objectForKey:@"fillLineGap"]) {
        BOOL fillLineGap = [[dictionary objectForKey:@"fillLineGap"] boolValue];
        [styleDictionary setValue:[NSNumber numberWithBool:fillLineGap] forKey:@"fillLineGap"];
    }
    ...
    if ([dictionary objectForKey:@"wrapOption"]) {
        [styleDictionary setValue:[dictionary objectForKey:@"wrapOption"] forKey:@"wrapOption"];
    }
