...
- (NSUInteger)hash
{
    NSString *description = [NSString stringWithFormat:@"<%@:begin = %f, end = %f, styleDictionary = %@, chunks = %@>", NSStringFromClass([self class]), self.begin, self.end, self.styleDictionary, self.subtitleChunks];
