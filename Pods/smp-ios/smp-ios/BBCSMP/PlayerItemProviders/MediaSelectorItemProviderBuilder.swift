...
public class MediaSelectorItemProviderBuilder: NSObject {
    ...
    private let avStatisticsConsumer: AVStatisticsConsumerProtocol
    ...
    public class func builderWithVPID(_ vpid: String, mediaSet: String, AVType: BBCSMPAVType, streamType: BBCSMPStreamType,
                                      avStatisticsConsumer: AVStatisticsConsumerProtocol) -> MediaSelectorItemProviderBuilder {
    ...
    public init(VPID: String, mediaSet: String, AVType: BBCSMPAVType, streamType: BBCSMPStreamType, avStatisticsConsumer: AVStatisticsConsumerProtocol) {
        self.VPID = VPID
