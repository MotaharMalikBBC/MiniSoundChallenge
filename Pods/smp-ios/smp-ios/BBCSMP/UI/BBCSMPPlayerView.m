...
@property (nonatomic, strong) BBCSMPSubtitleViewBuilder* subtitleViewBuilder;
...
- (void)initialiseUserInterface
{
    ...
    _subtitleViewBuilder = [[[BBCSMPSubtitleViewBuilder alloc] initWithPlayer:_player] withConfiguration:_configuration];
    self.subtitleView = [_subtitleViewBuilder createSubtitleView];
