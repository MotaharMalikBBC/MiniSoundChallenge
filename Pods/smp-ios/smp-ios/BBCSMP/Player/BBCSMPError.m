...
NSErrorDomain const BBCSMPErrorDomain  = @"BBCSMPErrorDomain";
...
{
    NSError *underlyingError = error ? error : [NSError errorWithDomain:BBCSMPErrorDomain code:1 userInfo:@{ NSLocalizedDescriptionKey : @"An unknown error occurred" }];
