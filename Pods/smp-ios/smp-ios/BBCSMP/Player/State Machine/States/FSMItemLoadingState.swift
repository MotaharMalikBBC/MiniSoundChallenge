    ...
    override func didBecomeActive() {
        ...
        fsm?.playerItemRequester.requestItem(itemProvider: unwrappedPlayerItemProvider,
            ...
            guard let resolvedItem = item else {
                let error = NSError(domain: SMPErrorDomain, code: SMPErrorCodes.Playback.initialLoadFailed, userInfo: nil)
            ...
            let networkParseFailureErrorCode = SMPErrorCodes.Playback.initialLoadFailed
            ...
            if error?._code == SMPErrorCodes.MediaResolution.selectionUnavailableWithToken {
            ...
            if let itemProviderError = error {
                ...
                errorForSMP = NSError(domain: SMPErrorDomain, code: 0, userInfo: nil)
            }
