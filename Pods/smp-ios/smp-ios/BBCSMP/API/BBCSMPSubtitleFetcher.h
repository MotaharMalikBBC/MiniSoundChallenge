...
- (void)fetchSubtitles:(NSURL *)url success:(BBCSMPSubtitleFetchSuccess)success  failure:(BBCSMPSubtitleFetchFailure)failure NS_SWIFT_NAME(fetchSubtitles(url:success:failure:));
